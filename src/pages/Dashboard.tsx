    ...
    <>
      ...
      <div className="mainContainer">
        ...
        <div className="cardsContainer">
          {data.map((hotel:any,i:number)=>(<HotelCard key={i} setApiRef={setApiRef} title={hotel.name} apiRef={hotel.slug.current}  setReservationsData={setReservationsData}/>))}
        </div>
        <div className="reservationContainer">
          ...
          {reservationsData.map((res,i)=>(<ReservationCard  apiRef={apiRef} plans={res.selectedPlans} name={res.username} email={res.email} checkIn={res.checkIn} checkOut={res.checkOut} amountPaid={res.amountPaid} key={i} />))}
        </div>
